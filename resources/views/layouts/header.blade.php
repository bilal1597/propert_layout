    ...
    <section class="text-secondary bg-light">
      ...
      <nav class="navbar navbar-expand-lg bg-body-tertiary sticky-top">
        <div class="container-fluid">
          <a class="navbar-brand ms-lg-5" href="{{route('index.property')}}"
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-lg-3">
              <li class="nav-item">
                <a class="nav-link links" href="{{route('index.property')}}">Home</a>
              </li>
              <li class="nav-item">
                <a class="nav-link links" href="{{route('projects.property')}}">Project</a>
              </li>
              <li class="nav-item">
                <a class="nav-link links" href="{{route('about.property')}}">About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link links" href="{{route('services.property')}}">Services</a>
              </li>
              <li class="nav-item me-2">
                <a class="nav-link links" href="{{route('contact.property')}}">Contact</a>
              </li>
